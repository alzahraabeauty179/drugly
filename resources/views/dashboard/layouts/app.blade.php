...
<html class="loading" lang="en" data-textdirection="ltr">
    <head>
        ...
        <link
            ...
            href="{{ asset('dashboard_files/app-assets/images/ico/apple-icon-120.png') }}"
        />
        <link
            rel="shortcut icon"
            type="image/x-icon"
        ...
        <link
            rel="stylesheet"
            type="text/css"
            href="{{ asset('dashboard_files/app-assets/css-rtl/vendors.min.css') }}"
        />
        <link
            rel="stylesheet"
            type="text/css"
        ...
        <link
            rel="stylesheet"
            type="text/css"
            href="{{ asset('dashboard_files/app-assets/css-rtl/app.min.css') }}"
        />
        <link
            rel="stylesheet"
            type="text/css"
    ...
    <body
        ...
        <script src="{{ asset('dashboard_files/app-assets/vendors/js/charts/raphael-min.js') }}" type="text/javascript"></script>
        <script src="{{ asset('dashboard_files/app-assets/vendors/js/charts/morris.min.js') }}" type="text/javascript"></script>
        <script src="{{ asset('dashboard_files/app-assets/vendors/js/extensions/unslider-min.js') }}" type="text/javascript"></script>
        <script src="{{ asset('dashboard_files/app-assets/vendors/js/timeline/horizontal-timeline.js') }}" type="text/javascript"></script>
        <!-- END PAGE VENDOR JS-->
        <!-- BEGIN maoqe3 JS-->
        ...
        <script src="{{ asset('dashboard_files/app-assets/js/scripts/customizer.min.js') }}" type="text/javascript"></script>
        <!-- END maoqe3 JS-->
        <!-- BEGIN PAGE LEVEL JS-->
        <script src="{{ asset('dashboard_files/app-assets/js/scripts/pages/dashboard-ecommerce.min.js') }}" type="text/javascript"></script>
        <!-- END PAGE LEVEL JS-->
    </body>
</html>
