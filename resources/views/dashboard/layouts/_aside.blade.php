        ...
        >
            ...
            <li class="nav-item">
                <a
                    ...
                    >Cosmetic Companies</span
                    ></a
                >
                <ul class="menu-content">
                    <li>
                    <a class="menu-item" href="cosmetic-companies.html"
                        >All Companies</a
                    >
                    </li>
                    <li>
                    <a class="menu-item" href="#"
                        >Request Product / Medical Supplies</a
                    >
                    </li>
                    <li><a class="menu-item" href="#">Soon</a></li>
                </ul>
            ...
            <li class="nav-item">
                ...
                <ul class="menu-content">
                    ...
                    <li>
                    <a class="menu-item" href="add-category.html">Add Category</a>
                    </li>
                    <li>
                    <a class="menu-item" href="add-sub-category.html"
                        >Add Sub Category</a
                    >
                    </li>
                    <li><a class="menu-item" href="#">Soon</a></li>
            ...
            <li class="nav-item">
                <a
                    ><i class="ft-tag"></i
                    ><span class="menu-title" data-i18n="">Trademarks</span></a
                >
                <ul class="menu-content">
                    <li>
            ...
            <li class="nav-item">
                <a
                    ...
                    ><span class="menu-title" data-i18n="">Offers prices</span></a
                >
                <ul class="menu-content">
                    <li><a class="menu-item" href="#">Soon</a></li>
                    <li><a class="menu-item" href="#">Soon</a></li>
            ...
            <li class="nav-item">
                <a
                    ...
                    ><span class="menu-title" data-i18n="">Consulting</span></a
                >
                <ul class="menu-content">
