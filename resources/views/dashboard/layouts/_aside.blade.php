...
<div class="main-menu menu-fixed menu-light menu-accordion" data-scroll-to-active="true">
    <div class="main-menu-content">
        ...
        {{-- <li><a class="menu-item" href="{{ route('dashboard.productsdetails.index') }}">@lang('site.all')
        @lang('site.subproducts')</a></li> --}}
        {{-- <li>
                        <a class="menu-item" href="{{ route('dashboard.subproducts.create') }}">@lang('site.add')
        @lang('site.subcategory')</a>
        </li> --}}
        </ul>
        </li>
