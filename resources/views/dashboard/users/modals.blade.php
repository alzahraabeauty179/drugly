    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content" style="width: 140%;">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <h4 class="card-title">@lang('site.update_site_information')</h4>
                    <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>
                    <div class="heading-elements">
                        <ul class="list-inline mb-0">
                            <li><a class="close" data-dismiss="modal" aria-label="Close"><i class="ft-x"></i></a></li>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea   id="{{ $locale }}[description]" rows="5" class="form-control @error($locale . ' .description') is-invalid @enderror" 
                                                    ...
                                                    @if( !is_null($app_settings) ) {!! $app_settings->translate($locale)->description !!} @endif
                                                </textarea>
                                            </div>
                                        </div>
                                    @endforeach
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea   id="{{ $locale }}[about_us]" rows="5" class="form-control @error($locale . ' .about_us') is-invalid @enderror" 
                                                    ...
                                                    @if( !is_null($app_settings) ) {!! $app_settings->translate($locale)->about_us !!} @endif
                                                </textarea>
                                            </div>
                                        </div>
                                    @endforeach
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea   id="{{ $locale }}[privacy_policy]" rows="5" class="form-control @error($locale . ' .privacy_policy') is-invalid @enderror" 
                                                    ...
                                                    @if( !is_null($app_settings) ) {!! $app_settings->translate($locale)->privacy_policy !!} @endif
                                                </textarea>
                                            </div>
                                        </div>
                                    @endforeach
